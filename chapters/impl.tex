...
Looking at \todo{fig 1}, we have a cube inside our room being tracked by our Optitrack sensor, hence, we receive its raw positional data, i.e., its \ac{VP}, which is calculated based on the tracking system coordinates' origin.
