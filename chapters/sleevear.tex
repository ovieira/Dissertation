...
For accomplishing this first task, a patient must follow SleeveAR's feedback to achieve the correct arm position (all such feedback information is explained in section \ref{sec:feedback}).
...
At the end of each exercise, SleeveAR should provide an overview of the patient's performance in comparison with the original. 
