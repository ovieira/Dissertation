...
Results from the questionnaire suggest that there are no statistically relevant differences between the usability of the two tested approaches. Indeed, there are \todo{Acrescentei o NO: parece-me que sem este o resto da frase estava em contradição} no big discrepancies worth highlighting between the values obtained weather by observing a video or following the SleeveAR's prototype.
...
The questionnaire included questions regarding the visual feedback, as shown in Table~\ref{table:widgets}, to evaluate how easy it was to understand its meaning \todo{o que concluir destes valores?}. Participants were also free to share any personal thoughts regarding every visual feedback presented during the tests.
